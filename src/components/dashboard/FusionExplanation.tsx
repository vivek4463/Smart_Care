    ...
    <div className="premium-card p-10 space-y-10 relative overflow-hidden">
      ...
      <div className="flex items-center gap-4 relative z-10">
        ...
        <div className="space-y-1">
          <h3 className="text-xl font-black text-white tracking-tighter uppercase italic leading-none">Fusion Architecture</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-center relative z-10">
        <div className="lg:col-span-2 space-y-6">
          {sources.map((source, i) => (
            ...
            >
              <div className={`p-2.5 rounded-xl bg-white/5 ${source.color} group-hover:bg-current group-hover:text-brand-teal transition-all`}>
